...
public class RedisClientFactory {
    ...
    public RedisClientFactory() {
        jedisPool = new JedisPool(new JedisPoolConfig(), "localhost", 6379, 3000, "123456");
    }

    public RedisClient getLettuceClientStandalone() {
        //单机
        return RedisClient.create("redis://redis:123456@127.0.0.1:6379");
    }
    ...
    public Jedis getJedisClientStandalone() {
